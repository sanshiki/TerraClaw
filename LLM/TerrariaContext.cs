...
public sealed class EntityContextBuilder : ContextBundle
{
    ...
    {
        Add(new NearbyHostilesComponent(center, radius, max));
        return this;
    }
}
...
/// <summary>Symbolic provider for hostile NPCs within a radius of a world position.</summary>
public sealed class NearbyHostilesComponent : ISymbolicContextProvider
{
    private readonly Vector2 _center;
    private readonly float _radius;
    private readonly int _max;

    public NearbyHostilesComponent(Vector2 center, float radius, int max)
    {
        _center = center;
        _radius = radius;
        _max = max;
    ...
    public string Symbol => "hostile";
    public string Description => "Nearby hostile NPCs";
    public IReadOnlyList<SymbolicField> Fields { get; } = new[]
    {
        new SymbolicField("count", "hostile count in radius"),
    ...
    public void AddContext(JsonObject target)
    {
        ...
        target["nearby_hostiles"] = new JsonObject
        {
            ["radius"] = _radius,
